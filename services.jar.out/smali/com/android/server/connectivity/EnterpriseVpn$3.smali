...
.method public interfaceRemoved(Ljava/lang/String;)V
    ...
    invoke-static {v9}, Lcom/android/server/connectivity/EnterpriseVpn;->access$700(Lcom/android/server/connectivity/EnterpriseVpn;)Z
    ...
    # getter for: Lcom/android/server/connectivity/EnterpriseVpn;->isMetaDataEnabled:Z
    ...
    .line 630
    const-string v9, "net.vpn.markbase"
    ...
    invoke-static {v9}, Lcom/android/server/connectivity/EnterpriseVpn;->access$900(Lcom/android/server/connectivity/EnterpriseVpn;)Lcom/android/internal/net/VpnConfig;
    ...
    invoke-static {v9}, Lcom/android/server/connectivity/EnterpriseVpn;->access$1000(Lcom/android/server/connectivity/EnterpriseVpn;)Lcom/android/server/ConnectivityService$VpnCallback;
    ...
    invoke-static {v9}, Lcom/android/server/connectivity/EnterpriseVpn;->access$1100(Lcom/android/server/connectivity/EnterpriseVpn;)Lcom/android/server/connectivity/EnterpriseVpn$Connection;
    ...
    invoke-static {v9}, Lcom/android/server/connectivity/EnterpriseVpn;->access$1200(Lcom/android/server/connectivity/EnterpriseVpn;)Landroid/content/Context;
    ...
    # getter for: Lcom/android/server/connectivity/EnterpriseVpn;->mConnection:Lcom/android/server/connectivity/EnterpriseVpn$Connection;
    invoke-static {v10}, Lcom/android/server/connectivity/EnterpriseVpn;->access$1100(Lcom/android/server/connectivity/EnterpriseVpn;)Lcom/android/server/connectivity/EnterpriseVpn$Connection;
    ...
    invoke-static {v9, v10}, Lcom/android/server/connectivity/EnterpriseVpn;->access$1102(Lcom/android/server/connectivity/EnterpriseVpn;Lcom/android/server/connectivity/EnterpriseVpn$Connection;)Lcom/android/server/connectivity/EnterpriseVpn$Connection;
    ...
    invoke-static {v9, v10}, Lcom/android/server/connectivity/EnterpriseVpn;->access$1300(Lcom/android/server/connectivity/EnterpriseVpn;I)V
    ...
    const-string v9, "disconnect per-app vpn is getting called from enterprisevpn"
    ...
    # getter for: Lcom/android/server/connectivity/EnterpriseVpn;->mRouteInfo:Z
    invoke-static {v10}, Lcom/android/server/connectivity/EnterpriseVpn;->access$700(Lcom/android/server/connectivity/EnterpriseVpn;)Z
    ...
    new-instance v9, Lcom/android/server/connectivity/EnterpriseVpn$3$2;

    invoke-direct {v9, p0}, Lcom/android/server/connectivity/EnterpriseVpn$3$2;-><init>(Lcom/android/server/connectivity/EnterpriseVpn$3;)V
