...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    .line 241
    iput-boolean v2, p0, Lcom/android/server/display/DisplayManagerService;->mHasCocktailBar:Z
    ...
    .line 248
    const-string/jumbo v0, "ro.config.headless"
    ...
    iput-boolean v0, p0, Lcom/android/server/display/DisplayManagerService;->mHasCocktailBar:Z
...
.method private handleDisplayDeviceAddedLocked(Lcom/android/server/display/DisplayDevice;)V
    ...
    const-string/jumbo v4, "save the name and address and add replaced device"
...
.method private registerAdditionalDisplayAdapters()V
    ...
    .line 1014
    invoke-direct {p0}, Lcom/android/server/display/DisplayManagerService;->registerMagnifierDisplayAdapter()V
...
.method private registerMagnifierDisplayAdapter()V
    .locals 6
...
.method public getDisplayInfo(I)Landroid/view/DisplayInfo;
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/server/display/DisplayManagerService;->getDisplayInfoEx(ILandroid/os/IBinder;)Landroid/view/DisplayInfo;
...
.method public getDisplayInfoEx(ILandroid/os/IBinder;)Landroid/view/DisplayInfo;
    ...
    iget-object v15, v0, Lcom/android/server/display/DisplayManagerService;->mSyncRoot:Lcom/android/server/display/DisplayManagerService$SyncRoot;
    ...
    iget-boolean v14, v0, Lcom/android/server/display/DisplayManagerService;->mHasCocktailBar:Z
    ...
    instance-of v14, v0, Landroid/view/IApplicationToken;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .end local p2    # "appToken":Landroid/os/IBinder;
    invoke-interface/range {p2 .. p2}, Landroid/view/IApplicationToken;->hasSubWindow()Z
    ...
    .line 487
    iget v2, v7, Landroid/view/DisplayInfo;->appWidth:I
    ...
    iput v1, v7, Landroid/view/DisplayInfo;->appWidth:I
    ...
    iget v0, v0, Lcom/android/server/display/DisplayManagerService;->mCocktailSize:I

    move/from16 v16, v0

    sub-int v14, v14, v16

    iput v14, v7, Landroid/view/DisplayInfo;->alphaScreenAppWidth:I
    ...
    :cond_1
    :goto_2
    invoke-virtual {v7, v3}, Landroid/view/DisplayInfo;->hasAccess(I)Z
    ...
    iget-object v14, v0, Lcom/android/server/display/DisplayManagerService;->mScaledPids:Ljava/util/HashMap;
    ...
    .line 510
    .local v8, "mDssHelper":Landroid/os/DssHelper;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v8, v14}, Landroid/os/DssHelper;->getScalingFactor(Ljava/lang/String;)D
    ...
    iput v14, v6, Landroid/view/DisplayInfo;->logicalDensityDpi:I

    .line 514
    iget v14, v6, Landroid/view/DisplayInfo;->physicalXDpi:F

    mul-float/2addr v14, v10

    iput v14, v6, Landroid/view/DisplayInfo;->physicalXDpi:F

    .line 515
    iget v14, v6, Landroid/view/DisplayInfo;->physicalYDpi:F

    mul-float/2addr v14, v10

    iput v14, v6, Landroid/view/DisplayInfo;->physicalYDpi:F
    ...
    iput v14, v6, Landroid/view/DisplayInfo;->logicalHeight:I
    ...
    iput v14, v6, Landroid/view/DisplayInfo;->logicalWidth:I

    .line 518
    iget v14, v6, Landroid/view/DisplayInfo;->appHeight:I
    ...
    iput v14, v6, Landroid/view/DisplayInfo;->appHeight:I

    .line 519
    iget v14, v6, Landroid/view/DisplayInfo;->appWidth:I
    ...
    iput v14, v6, Landroid/view/DisplayInfo;->appWidth:I
    ...
    .line 522
    iget v14, v6, Landroid/view/DisplayInfo;->alphaScreenAppWidth:I
    ...
    iput v14, v6, Landroid/view/DisplayInfo;->alphaScreenAppWidth:I

    .line 523
    iget v14, v6, Landroid/view/DisplayInfo;->alphaScreenAppHeight:I
    ...
    iput v14, v6, Landroid/view/DisplayInfo;->alphaScreenAppHeight:I
    ...
    .end local v6    # "fakeInfo":Landroid/view/DisplayInfo;
    .end local v7    # "info":Landroid/view/DisplayInfo;
    .end local v8    # "mDssHelper":Landroid/os/DssHelper;
    .end local v10    # "resolutionFactorf":F
    .end local v11    # "scalfac":Ljava/lang/Double;
    :goto_3
    return-object v6

    .line 482
    .restart local v4    # "diff":I
    .restart local v7    # "info":Landroid/view/DisplayInfo;
    :cond_3
    :try_start_4
    move-object/from16 v0, p0
    ...
    :cond_4
    :try_start_5
    iget v2, v7, Landroid/view/DisplayInfo;->appHeight:I

    .line 491
    .restart local v2    # "before":I
    iget v14, v7, Landroid/view/DisplayInfo;->logicalHeight:I

    sub-int v1, v14, v4

    iput v1, v7, Landroid/view/DisplayInfo;->appHeight:I

    .restart local v1    # "after":I
    goto/16 :goto_1
    ...
    iput v14, v7, Landroid/view/DisplayInfo;->alphaScreenAppHeight:I
