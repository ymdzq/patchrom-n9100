...
.method private tryConnectDisplayLocked(I)V
    ...
    iget-object v3, p0, Lcom/android/server/display/LocalDisplayAdapter;->mTempPhys:Landroid/view/SurfaceControl$PhysicalDisplayInfo;

    invoke-static {v1, v3}, Landroid/view/SurfaceControl;->getDisplayInfo(Landroid/os/IBinder;Landroid/view/SurfaceControl$PhysicalDisplayInfo;)Z
    ...
    .line 74
    iget-object v3, p0, Lcom/android/server/display/LocalDisplayAdapter;->mDevices:Landroid/util/SparseArray;
    ...
    invoke-direct {v2, p0, v1, p1, v3}, Lcom/android/server/display/LocalDisplayAdapter$LocalDisplayDevice;-><init>(Lcom/android/server/display/LocalDisplayAdapter;Landroid/os/IBinder;ILandroid/view/SurfaceControl$PhysicalDisplayInfo;)V

    .line 78
    .local v2, "tempDevice":Lcom/android/server/display/LocalDisplayAdapter$LocalDisplayDevice;
    iget-object v3, p0, Lcom/android/server/display/LocalDisplayAdapter;->mDevices:Landroid/util/SparseArray;
    ...
    new-instance v4, Lcom/android/server/display/LocalDisplayAdapter$1;

    invoke-direct {v4, p0, v2}, Lcom/android/server/display/LocalDisplayAdapter$1;-><init>(Lcom/android/server/display/LocalDisplayAdapter;Lcom/android/server/display/LocalDisplayAdapter$LocalDisplayDevice;)V
    ...
    .end local v2    # "tempDevice":Lcom/android/server/display/LocalDisplayAdapter$LocalDisplayDevice;
    :cond_0
    :goto_0
    return-void
    ...
    invoke-virtual {v0, v3}, Lcom/android/server/display/LocalDisplayAdapter$LocalDisplayDevice;->updatePhysicalDisplayInfoLocked(Landroid/view/SurfaceControl$PhysicalDisplayInfo;)Z
    ...
    invoke-virtual {p0, v0, v3}, Lcom/android/server/display/DisplayAdapter;->sendDisplayDeviceEventLocked(Lcom/android/server/display/DisplayDevice;I)V
