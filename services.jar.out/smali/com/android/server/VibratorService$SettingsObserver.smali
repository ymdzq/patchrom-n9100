...
.method constructor <init>(Lcom/android/server/VibratorService;I)V
    ...
    invoke-static {p1}, Lcom/android/server/VibratorService;->access$2200(Lcom/android/server/VibratorService;)Landroid/content/ContentResolver;

    move-result-object v0

    # getter for: Lcom/android/server/VibratorService;->mTypeURIs:[Ljava/lang/String;
    invoke-static {p1}, Lcom/android/server/VibratorService;->access$2100(Lcom/android/server/VibratorService;)[Ljava/lang/String;
...
.method public onChange(Z)V
    ...
    invoke-static {v1}, Lcom/android/server/VibratorService;->access$2300(Lcom/android/server/VibratorService;)Lcom/immersion/android/ImmVibe;
    ...
    # getter for: Lcom/android/server/VibratorService;->mContentResolver:Landroid/content/ContentResolver;
    invoke-static {v1}, Lcom/android/server/VibratorService;->access$2200(Lcom/android/server/VibratorService;)Landroid/content/ContentResolver;
    ...
    # getter for: Lcom/android/server/VibratorService;->mTypeURIs:[Ljava/lang/String;
    invoke-static {v2}, Lcom/android/server/VibratorService;->access$2100(Lcom/android/server/VibratorService;)[Ljava/lang/String;
    ...
    invoke-static {v1, v0}, Lcom/android/server/VibratorService;->access$2402(Lcom/android/server/VibratorService;I)I
    ...
    invoke-static {v1}, Lcom/android/server/VibratorService;->access$2800(Lcom/android/server/VibratorService;)Z
    ...
    invoke-static {v2}, Lcom/android/server/VibratorService;->access$2700(Lcom/android/server/VibratorService;)I
...
.method reload()V
    ...
    # getter for: Lcom/android/server/VibratorService;->mContentResolver:Landroid/content/ContentResolver;
    invoke-static {v0}, Lcom/android/server/VibratorService;->access$2200(Lcom/android/server/VibratorService;)Landroid/content/ContentResolver;
    ...
    # getter for: Lcom/android/server/VibratorService;->mTypeURIs:[Ljava/lang/String;
    invoke-static {v1}, Lcom/android/server/VibratorService;->access$2100(Lcom/android/server/VibratorService;)[Ljava/lang/String;
