...
.method private getDataSyncPolicy(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v14, v0}, Lcom/android/server/pm/PersonaManagerService;->exists(I)Z
    ...
    .line 1307
    .local v6, "isPersona":Z
    :goto_0
    move-object/from16 v0, p0

    move-object/from16 v1, p3

    invoke-direct {v0, v6, v1}, Lcom/android/server/pm/PersonaPolicyManagerService;->getDefaultRCPPolicy(ZLjava/lang/String;)Ljava/lang/String;
    ...
    .restart local v6    # "isPersona":Z
    :cond_2
    const/4 v8, 0x0

    .line 1312
    .local v8, "mdmValue":Ljava/lang/String;
    ...
    check-cast v10, Lcom/android/server/enterprise/container/KnoxMUMRCPPolicyService;

    .line 1314
    .local v10, "rcpPolicy":Lcom/android/server/enterprise/container/KnoxMUMRCPPolicyService;
    if-eqz v10, :cond_3
    ...
    invoke-virtual {v10, v0, v1, v2}, Lcom/android/server/enterprise/container/KnoxMUMRCPPolicyService;->getDataSyncPolicyByUser(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v14, "knox-sanitize-data"
    ...
    invoke-virtual {v14, v0}, Lcom/android/server/pm/PersonaManagerService;->getPersonaInfo(I)Landroid/content/pm/PersonaInfo;

    move-result-object v5

    .line 1322
    .local v5, "info":Landroid/content/pm/PersonaInfo;
    if-eqz v5, :cond_4

    iget-boolean v14, v5, Landroid/content/pm/PersonaInfo;->sdpEnabled:Z

    if-eqz v14, :cond_4

    iget-boolean v14, v5, Landroid/content/pm/PersonaInfo;->isSdpMinor:Z
    ...
    .line 1327
    .end local v5    # "info":Landroid/content/pm/PersonaInfo;
    :cond_4
    if-eqz v8, :cond_5
    ...
    .line 1331
    .local v9, "policy":Lcom/android/server/pm/PersonaPolicyManagerService$PersonaPolicyData;
    if-eqz v9, :cond_7

    .line 1332
    iget-object v14, v9, Lcom/android/server/pm/PersonaPolicyManagerService$PersonaPolicyData;->mRCPDataSettings:Ljava/util/HashMap;
    ...
    .line 1334
    .local v7, "list":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/pm/PersonaPolicyManagerService$PersonaRCPSettings;>;"
    if-eqz v7, :cond_7
    ...
    check-cast v11, Lcom/android/server/pm/PersonaPolicyManagerService$PersonaRCPSettings;

    .line 1336
    .local v11, "setting":Lcom/android/server/pm/PersonaPolicyManagerService$PersonaRCPSettings;
    iget-object v14, v11, Lcom/android/server/pm/PersonaPolicyManagerService$PersonaRCPSettings;->property:Ljava/lang/String;
    ...
    .line 1337
    iget-object v14, v11, Lcom/android/server/pm/PersonaPolicyManagerService$PersonaRCPSettings;->value:Ljava/lang/String;
    ...
    .line 1338
    iget-object v3, v11, Lcom/android/server/pm/PersonaPolicyManagerService$PersonaRCPSettings;->value:Ljava/lang/String;
    ...
    .end local v7    # "list":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/pm/PersonaPolicyManagerService$PersonaRCPSettings;>;"
    .end local v9    # "policy":Lcom/android/server/pm/PersonaPolicyManagerService$PersonaPolicyData;
    .end local v11    # "setting":Lcom/android/server/pm/PersonaPolicyManagerService$PersonaRCPSettings;
    :catchall_0
    move-exception v14
    ...
    .line 1348
    .local v12, "typeObj":Lcom/sec/enterprise/knox/container/KnoxConfigurationType;
    if-eqz v12, :cond_0
    ...
    invoke-virtual {v12, v0, v1}, Lcom/sec/enterprise/knox/container/KnoxConfigurationType;->getDataSyncPolicy(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v16, "configuration value set by MDM : "
