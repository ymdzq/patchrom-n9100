...
.method static constructor <clinit>()V
    ...
    .line 258
    sput-boolean v1, Lcom/android/server/LocationManagerService;->gps_initflag:Z
...
.method private requestLocationUpdatesLocked(Landroid/location/LocationRequest;Lcom/android/server/LocationManagerService$Receiver;IILjava/lang/String;)V
    ...
    const-string v15, "provider name must not be null"
    ...
    const-string v16, "provider doesn\'t exist: "
    ...
    .line 1750
    :cond_2
    new-instance v12, Lcom/android/server/LocationManagerService$UpdateRecord;
    ...
    invoke-direct {v12, v0, v8, v1, v2}, Lcom/android/server/LocationManagerService$UpdateRecord;-><init>(Lcom/android/server/LocationManagerService;Ljava/lang/String;Landroid/location/LocationRequest;Lcom/android/server/LocationManagerService$Receiver;)V
    ...
    invoke-virtual {v9, v14}, Lcom/android/server/LocationManagerService$UpdateRecord;->disposeLocked(Z)V
    ...
    invoke-direct {v0, v8, v1}, Lcom/android/server/LocationManagerService;->isAllowedByUserSettingsLocked(Ljava/lang/String;I)Z
    ...
    iget-object v14, v0, Lcom/android/server/LocationManagerService;->mPowerManager:Landroid/os/PowerManager;
    ...
    const-string/jumbo v15, "request updating cell info for NETWORK_PROVIDER "
    ...
    :try_start_0
    invoke-virtual {v4, v14}, Ljava/io/DataOutputStream;->writeByte(I)V
    ...
    invoke-virtual {v4, v14}, Ljava/io/DataOutputStream;->writeShort(I)V
    ...
    invoke-interface {v10, v14}, Lcom/android/internal/telephony/ITelephony;->invokeOemRilRequestRaw([B)V

    .line 1773
    const-string v14, "LocationManagerService"

    const-string v15, " sending the RIL command"
    ...
    invoke-virtual {v0, v14}, Lcom/android/server/LocationManagerService$Receiver;->updateMonitoring(Z)V
    ...
    .restart local v13    # "vendor":Ljava/lang/String;
    :catch_0
    move-exception v5
    ...
    const-string v16, "exception occured during send command to RIL"
    ...
    invoke-direct {v0, v8}, Lcom/android/server/LocationManagerService;->applyRequirementsLocked(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v8, v14}, Lcom/android/server/LocationManagerService$Receiver;->callProviderEnabledLocked(Ljava/lang/String;Z)Z
