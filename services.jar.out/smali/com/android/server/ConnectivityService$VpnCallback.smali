...
.method public checkIfProtectIscalledByKnoxProfile(Landroid/os/ParcelFileDescriptor;)Z
    .locals 11
    ...
    .line 7161
    .local v5, "protectCalledByKnoxProfile":Z
    :try_start_0
    ...
    const-string v10, "checkIfProtectIscalledByKnoxProfile: callerUid is "
    ...
    .line 7164
    iget-object v8, p0, Lcom/android/server/ConnectivityService$VpnCallback;->this$0:Lcom/android/server/ConnectivityService;

    # getter for: Lcom/android/server/ConnectivityService;->mEnterpriseVpnStoreObj:Landroid/util/SparseArray;
    invoke-static {v8}, Lcom/android/server/ConnectivityService;->access$5400(Lcom/android/server/ConnectivityService;)Landroid/util/SparseArray;
    ...
    .line 7166
    .local v7, "vpnIterator":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/lang/String;>;"
    :cond_0
    ...
    const-string v10, "checkIfProtectIscalledByKnoxProfile profile is "
    ...
    invoke-virtual {v8}, Lcom/android/server/connectivity/EnterpriseVpn;->getPackageName()Ljava/lang/String;
    ...
    # invokes: Lcom/android/server/ConnectivityService;->getUIDForPackage(ILjava/lang/String;)I
    invoke-static {v8, v6, v2}, Lcom/android/server/ConnectivityService;->access$5500(Lcom/android/server/ConnectivityService;ILjava/lang/String;)I

    move-result v3

    .line 7171
    .local v3, "packageUidStored":I
    if-eqz v2, :cond_0
    ...
    const-string v10, "checkIfProtectIscalledByKnoxProfile: packageName is "
    ...
    const-string v10, "checkIfProtectIscalledByKnoxProfile: packageUidStored is "
    ...
    invoke-virtual {v8, p1, v4}, Lcom/android/server/ConnectivityService;->protectEnterpriseVpn(Landroid/os/ParcelFileDescriptor;Ljava/lang/String;)Z
    :try_end_0
    ...
    .end local v3    # "packageUidStored":I
    .end local v4    # "profileName":Ljava/lang/String;
    .end local v6    # "user":I
    .end local v7    # "vpnIterator":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/lang/String;>;"
    :cond_1
    :goto_0
    return v5
    ...
    const-string v10, "Exception at checkIfProtectIscalledByKnoxProfile "
...
.method public override(Ljava/lang/String;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-static {v0}, Lcom/android/server/ConnectivityService;->access$4700(Lcom/android/server/ConnectivityService;)Ljava/lang/Object;
    ...
    invoke-static/range {v0 .. v5}, Lcom/android/server/ConnectivityService;->access$4800(Lcom/android/server/ConnectivityService;Ljava/lang/String;Ljava/lang/String;Ljava/util/Collection;Ljava/lang/String;Z)V
    ...
    invoke-static {v0}, Lcom/android/server/ConnectivityService;->access$5200(Lcom/android/server/ConnectivityService;)Landroid/net/ProxyProperties;
    ...
    invoke-static {v0, v2}, Lcom/android/server/ConnectivityService;->access$5300(Lcom/android/server/ConnectivityService;Landroid/net/ProxyProperties;)V
...
.method public restore()V
    ...
    # getter for: Lcom/android/server/ConnectivityService;->mDefaultProxy:Landroid/net/ProxyProperties;
    invoke-static {v2}, Lcom/android/server/ConnectivityService;->access$5200(Lcom/android/server/ConnectivityService;)Landroid/net/ProxyProperties;
