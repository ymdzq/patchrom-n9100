...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/ProcessRecord;ILjava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/content/res/Configuration;Lcom/android/server/am/ActivityRecord;Ljava/lang/String;IZLcom/android/server/am/ActivityStackSupervisor;Lcom/android/server/am/ActivityRecord;Landroid/os/IBinder;)V
    ...
    iput-boolean v6, p0, Lcom/android/server/am/ActivityRecord;->waitingVisibleOnVR:Z
    ...
    iget-object v6, v0, Landroid/content/pm/PackageItemInfo;->nonLocalizedLabel:Ljava/lang/CharSequence;
    ...
    iget-object v6, v3, Landroid/content/pm/PackageItemInfo;->nonLocalizedLabel:Ljava/lang/CharSequence;

    iput-object v6, p0, Lcom/android/server/am/ActivityRecord;->nonLocalizedLabel:Ljava/lang/CharSequence;

    .line 487
    iget v6, v3, Landroid/content/pm/PackageItemInfo;->labelRes:I
    ...
    iget-object v6, v5, Lcom/android/server/AttributeCache$Entry;->array:Landroid/content/res/TypedArray;
    ...
    invoke-virtual {v6, p0, p2, v0, v1}, Lcom/android/server/am/MultiWindowPolicy;->applyMultiWindowStyle(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/ActivityRecord;Landroid/os/IBinder;)Lcom/samsung/android/multiwindow/MultiWindowStyle;
    ...
    iget-object v6, v6, Lcom/android/server/am/ActivityStackSupervisor;->mContext:Landroid/content/Context;
    ...
    .line 531
    iget-object v6, p0, Lcom/android/server/am/ActivityRecord;->multiWindowStyle:Lcom/samsung/android/multiwindow/MultiWindowStyle;
    ...
    iput-object v6, p0, Lcom/android/server/am/ActivityRecord;->lastRelaunchedMultiWindowStyle:Lcom/samsung/android/multiwindow/MultiWindowStyle;

    .line 540
    iget-object v6, p0, Lcom/android/server/am/ActivityRecord;->lastRelaunchedMultiWindowStyle:Lcom/samsung/android/multiwindow/MultiWindowStyle;

    const/4 v7, 0x1

    invoke-virtual {v6, v7}, Lcom/samsung/android/multiwindow/MultiWindowStyle;->setNull(Z)V
    ...
    invoke-virtual {v7}, Landroid/content/Intent;->getWindowScale()F

    move-result v7

    invoke-virtual {v6, p0, v7}, Lcom/android/server/am/MultiWindowPolicy;->setFloatingBounds(Lcom/android/server/am/ActivityRecord;F)V
    ...
    iget-object v4, v6, Landroid/content/pm/PackageItemInfo;->metaData:Landroid/os/Bundle;
    ...
    iput-object v6, p0, Lcom/android/server/am/ActivityRecord;->sourceActivity:Landroid/content/ComponentName;
    ...
    invoke-virtual {v6, v7, v0}, Lcom/android/server/am/MultiWindowPolicy;->getEnableMultiInstance(Landroid/content/pm/ActivityInfo;Landroid/content/Intent;)Z

    move-result v6

    iput-boolean v6, p0, Lcom/android/server/am/ActivityRecord;->bMultiInstance:Z
    ...
    const-string v7, "com.android.systemui.recent"
    ...
    const-string v6, "com.samsung.android.vr.activity"
...
.method private reportLaunchTimeLocked(J)V
    ...
    invoke-static {v0}, Lcom/android/server/am/ProcessList;->updateILS(Ljava/lang/String;)V
...
.method applyOptionsLocked()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/am/ActivityRecord;->applyOptionsLocked(Lcom/android/server/am/ActivityRecord;)V

    .line 866
    return-void
.end method

.method applyOptionsLocked(Lcom/android/server/am/ActivityRecord;)V
    .locals 13
    ...
    .line 934
    .end local v12    # "animationType":I
    :cond_1
    return-void

    .line 875
    .restart local v12    # "animationType":I
    :sswitch_0
    iget-object v0, p0, Lcom/android/server/am/ActivityRecord;->service:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-virtual {v6}, Landroid/app/ActivityOptions;->getStartWidth()I
    ...
    iget-object v0, v0, Lcom/android/server/am/ThumbnailHolder;->lastThumbnail:Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v1}, Landroid/app/ActivityOptions;->getStartWidth()I

    move-result v1

    iget-object v2, p0, Lcom/android/server/am/ActivityRecord;->pendingOptions:Landroid/app/ActivityOptions;

    invoke-virtual {v2}, Landroid/app/ActivityOptions;->getStartHeight()I
    ...
    .line 913
    .local v7, "screen":Landroid/graphics/Bitmap;
    if-eqz v7, :cond_0
    ...
    invoke-virtual/range {v6 .. v11}, Lcom/android/server/wm/WindowManagerService;->overridePendingAppTransitionThumb(Landroid/graphics/Bitmap;IILandroid/os/IRemoteCallback;Z)V
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    const-string/jumbo v7, "vrActivity="

    invoke-virtual {p1, v7}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget-boolean v7, p0, Lcom/android/server/am/ActivityRecord;->vrActivity:Z

    invoke-virtual {p1, v7}, Ljava/io/PrintWriter;->print(Z)V

    .line 316
    const-string v7, " waitingVisibleOnVR="

    invoke-virtual {p1, v7}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget-boolean v7, p0, Lcom/android/server/am/ActivityRecord;->waitingVisibleOnVR:Z
...
.method public hasSubWindow()Z
    ...
    invoke-virtual {v0, p0}, Lcom/android/server/am/ActivityManagerService;->isAppSpecific(Lcom/android/server/am/ActivityRecord;)Z
...
.method isVRActivity(Z)Z
    ...
    iget-boolean v0, v0, Lcom/android/server/am/ActivityManagerService;->mVRDevelopMode:Z
...
.method public windowsGone()V
    ...
    invoke-virtual {v0, p0}, Lcom/android/server/am/ActivityStackSupervisor;->reportActivityGoneLocked(Lcom/android/server/am/ActivityRecord;)V
