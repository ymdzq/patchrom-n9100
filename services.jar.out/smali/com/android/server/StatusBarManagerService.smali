...
.field private static final MODE_CHANGE_GRADATION:I = 0x1

.field private static final MODE_CHANGE_TRANSPARENT:I = 0x0
...
.field private static mIsTranparentONfromSimpleWindow:Z

.field private static mLastSemiTransparentMode:Z

.field private static mLastTransGradationMode:Z
...
.field private mLastModeChange:I
...
.method static constructor <clinit>()V
    ...
    .line 93
    sput-boolean v3, Lcom/android/server/StatusBarManagerService;->mLastSemiTransparentMode:Z

    .line 94
    sput-boolean v3, Lcom/android/server/StatusBarManagerService;->mLastTransGradationMode:Z

    .line 95
    sput-boolean v3, Lcom/android/server/StatusBarManagerService;->mIsTranparentONfromSimpleWindow:Z
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/WindowManagerService;)V
    ...
    .line 98
    iput v3, p0, Lcom/android/server/StatusBarManagerService;->mLastModeChange:I
    ...
    .line 134
    iput-boolean v3, p0, Lcom/android/server/StatusBarManagerService;->isCocktailBarPresent:Z
    ...
    iput-boolean v2, p0, Lcom/android/server/StatusBarManagerService;->isCocktailBarPresent:Z
...
.method private disableLocked(IILandroid/os/IBinder;Ljava/lang/String;)V
    ...
    :cond_0
    :goto_0
    iget-boolean v1, p0, Lcom/android/server/StatusBarManagerService;->isCocktailBarPresent:Z
    ...
    invoke-virtual {v1, v0}, Lcom/samsung/android/cocktailbar/CocktailBarManager;->setDisableTickerView(I)V
...
.method public setSemiTransparentMode(Z)V
    ...
    .line 1205
    :try_start_0
    sget-boolean v0, Lcom/android/server/StatusBarManagerService;->mIsTranparentONfromSimpleWindow:Z
    ...
    .line 1209
    :cond_0
    sput-boolean p1, Lcom/android/server/StatusBarManagerService;->mLastSemiTransparentMode:Z

    .line 1210
    const/4 v0, 0x0

    iput v0, p0, Lcom/android/server/StatusBarManagerService;->mLastModeChange:I
...
.method public setTransGradationMode(Z)V
    ...
    .line 1194
    :cond_0
    sput-boolean p1, Lcom/android/server/StatusBarManagerService;->mLastTransGradationMode:Z
...
.method public setUseWindowTrans(Z)V
    ...
    .line 1243
    iget v0, p0, Lcom/android/server/StatusBarManagerService;->mLastModeChange:I

    if-nez v0, :cond_1

    .line 1245
    sget-boolean v0, Lcom/android/server/StatusBarManagerService;->mLastTransGradationMode:Z

    invoke-virtual {p0, v0}, Lcom/android/server/StatusBarManagerService;->setWindowTransGradationMode(Z)V

    .line 1246
    sget-boolean v0, Lcom/android/server/StatusBarManagerService;->mLastSemiTransparentMode:Z
    ...
    :cond_0
    :goto_0
    sput-boolean p1, Lcom/android/server/StatusBarManagerService;->mIsTranparentONfromSimpleWindow:Z
...
.method public setWindowSemiTransparentMode(Z)V
    ...
    const-string/jumbo v2, "w.semi p:"
