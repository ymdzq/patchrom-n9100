...
.method public modifyVolumeLocked(Ljava/lang/String;IZLjava/lang/String;)I
    ...
    const-string v5, " :::: modifyStorageLocked :: path = "
    ...
    .line 3632
    .local v13, "activitySecureContainer":Z
    const/4 v15, 0x0
    ...
    const-string v3, "Missing storage path"
    ...
    .line 3642
    .local v14, "exited":Landroid/os/storage/StorageVolume;
    if-eqz v14, :cond_1

    .line 3643
    move-object/from16 v0, p0

    invoke-direct {v0, v14}, Lcom/android/server/MountService;->removeVolumeLocked(Landroid/os/storage/StorageVolume;)V
    ...
    invoke-direct/range {v1 .. v13}, Landroid/os/storage/StorageVolume;-><init>(Ljava/io/File;IZZZIZJLandroid/os/UserHandle;Ljava/lang/String;Z)V

    .line 3650
    .local v1, "volume":Landroid/os/storage/StorageVolume;
    move-object/from16 v0, p0

    invoke-direct {v0, v1}, Lcom/android/server/MountService;->addVolumeLocked(Landroid/os/storage/StorageVolume;)V
    ...
    invoke-virtual {v1, v2}, Landroid/os/storage/StorageVolume;->setState(Ljava/lang/String;)V
    ...
    .end local v14    # "exited":Landroid/os/storage/StorageVolume;
    :catchall_0
    move-exception v2
