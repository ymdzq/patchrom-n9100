...
.method dial(Ljava/lang/String;ILcom/android/internal/telephony/CallDetails;)Lcom/android/internal/telephony/Connection;
    ...
    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->setMute(Z)V
    ...
    .line 363
    iget v0, p3, Lcom/android/internal/telephony/CallDetails;->call_domain:I

    const/4 v1, 0x2

    if-ne v0, v1, :cond_b

    iget v0, p3, Lcom/android/internal/telephony/CallDetails;->call_type:I
    ...
    invoke-interface {v0, v1, p2, p3, v2}, Lcom/android/internal/telephony/CommandsInterface;->dialEmergencyCall(Ljava/lang/String;ILcom/android/internal/telephony/CallDetails;Landroid/os/Message;)V
    ...
    iput-boolean v0, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mPendingCallInEcm:Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iput-boolean v1, v0, Lcom/android/internal/telephony/CallTracker;->mRequestSuccess:Z
    ...
    iput v1, v0, Lcom/android/internal/telephony/CallTracker;->mCsFallback:I
    ...
    iget v3, v0, Lcom/android/internal/telephony/CallTracker;->mCsFallback:I
    ...
    iput-boolean v1, v0, Lcom/android/internal/telephony/CallTracker;->mSkipDisableDataConnection:Z
...
.method protected handlePollCalls(Landroid/os/AsyncResult;)V
    ...
    .line 768
    .local v33, "newRinging":Lcom/android/internal/telephony/Connection;
    const/16 v26, 0x0
    ...
    .line 772
    .local v32, "needsPollDelay":Z
    const/16 v36, 0x0

    .line 775
    .local v36, "unknownConnectionAppeared":Z
    const/4 v3, 0x0
    ...
    .end local v27    # "i":I
    .end local v32    # "needsPollDelay":Z
    .end local v33    # "newRinging":Lcom/android/internal/telephony/Connection;
    .end local v34    # "polledCalls":Ljava/util/List;
    .end local v36    # "unknownConnectionAppeared":Z
    :cond_3
    :goto_3
    return-void
    ...
    .restart local v32    # "needsPollDelay":Z
    .restart local v33    # "newRinging":Lcom/android/internal/telephony/Connection;
    .restart local v34    # "polledCalls":Ljava/util/List;
    .restart local v36    # "unknownConnectionAppeared":Z
    :cond_6
    const/16 v21, 0x0
    ...
    .line 856
    const-string v3, "Put 6 sec delay for enabling data after emerg call dropped for connecting data over EVDO."
    ...
    .line 936
    const-string v3, "Call collision case (ACTIVE/HOLDING -> DIALING)"
    ...
    .line 1016
    .local v35, "state":Lcom/android/internal/telephony/Call$State;
    ...
    .end local v18    # "conn":Lcom/android/internal/telephony/cdma/CdmaConnection;
    .end local v21    # "dc":Lcom/android/internal/telephony/DriverCall;
    .end local v35    # "state":Lcom/android/internal/telephony/Call$State;
    :cond_26
    move-object/from16 v0, p0
    ...
    .line 1094
    .restart local v18    # "conn":Lcom/android/internal/telephony/cdma/CdmaConnection;
    .restart local v29    # "isSetIncomingMissed":Z
    :cond_2f
    sget-object v15, Lcom/android/internal/telephony/Connection$DisconnectCause;->INCOMING_MISSED:Lcom/android/internal/telephony/Connection$DisconnectCause;
...
.method public hasCallOnLTE()Z
    ...
    iget v7, p0, Lcom/android/internal/telephony/CallTracker;->mCsFallback:I
...
.method public isAllActiveCallsOnLTE()Z
    ...
    .end local v2    # "call":Lcom/android/internal/telephony/Call;
    :cond_2
    iget v6, p0, Lcom/android/internal/telephony/CallTracker;->mCsFallback:I
