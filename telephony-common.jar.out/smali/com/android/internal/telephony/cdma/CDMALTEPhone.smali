...
.method public getSubscriberId()Ljava/lang/String;
    ...
    .line 415
    iget-object v0, p0, Lcom/android/internal/telephony/cdma/CDMALTEPhone;->mRuimRecords:Lcom/android/internal/telephony/uicc/RuimRecords;
...
.method protected onUpdateIccAvailability()V
    ...
    .line 493
    const-string v4, "Removing stale RuimRecords object."

    invoke-virtual {p0, v4}, Lcom/android/internal/telephony/cdma/CDMALTEPhone;->log(Ljava/lang/String;)V

    .line 494
    iput-object v6, p0, Lcom/android/internal/telephony/cdma/CDMALTEPhone;->mRuimRecords:Lcom/android/internal/telephony/uicc/RuimRecords;
    ...
    .line 497
    const-string v4, "New RuimRecords found"
    ...
    .line 511
    const-string v4, "Removing stale SIMRecords object."

    invoke-virtual {p0, v4}, Lcom/android/internal/telephony/cdma/CDMALTEPhone;->log(Ljava/lang/String;)V

    .line 512
    iput-object v6, p0, Lcom/android/internal/telephony/cdma/CDMALTEPhone;->mSimRecords:Lcom/android/internal/telephony/uicc/SIMRecords;
    ...
    .line 515
    const-string v4, "New SIMRecords found"
...
.method public updateCurrentCarrierInProvider()Z
    ...
    .line 312
    iget-object v6, p0, Lcom/android/internal/telephony/cdma/CDMALTEPhone;->mRuimRecords:Lcom/android/internal/telephony/uicc/RuimRecords;
    ...
    invoke-virtual {v6}, Lcom/android/internal/telephony/uicc/RuimRecords;->getOperatorNumeric()Ljava/lang/String;
    ...
    const-string v7, "updateCurrentCarrierInProvider from UICC(RUIM): numeric="
    ...
    invoke-virtual {p0, v6}, Lcom/android/internal/telephony/cdma/CDMALTEPhone;->log(Ljava/lang/String;)V
    ...
    invoke-virtual {v6, v3, v1}, Landroid/content/ContentResolver;->insert(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    invoke-virtual {v6, v2}, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->matchIccRecord(Ljava/lang/String;)Z
    ...
    .line 335
    const-string v6, "updateCurrentCarrierInProvider : matchIccRecord() = false!"
    ...
    invoke-virtual {v6, v7}, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->UpdateIccRecords(Z)V
    :try_end_0
    ...
    const-string v7, "updateCurrentCarrierInProvider from UICC(SIM): numeric="
    ...
    const-string v7, "updateCurrentCarrierInProvider from UICC: numeric="
...
.method updateCurrentCarrierInProvider(Ljava/lang/String;)Z
    ...
    .prologue
    .line 286
    const-string v2, "APP_FAM_3GPP"

    .line 287
    .local v2, "uiccFamilyName":Ljava/lang/String;
    const/4 v1, 0x1

    .line 288
    .local v1, "uiccFamily":I
    const-string v3, "CTC"
    ...
    invoke-virtual {v3, v1}, Lcom/android/internal/telephony/uicc/UiccController;->getUiccCardApplication(I)Lcom/android/internal/telephony/uicc/UiccCardApplication;
    ...
    const-string v4, "updateCurrentCarrierInProvider "
    ...
    const-string v4, "updateCurrentCarrierInProvider X retVal="
    ...
    .line 301
    :cond_2
    const-string v3, "updateCurrentCarrierInProvider not updated"
