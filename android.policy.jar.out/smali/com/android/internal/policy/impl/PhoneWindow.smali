...
.method private installDecor()V
    ...
    invoke-virtual/range {v30 .. v31}, Landroid/view/ViewGroup;->setDescendantFocusability(I)V
    ...
    invoke-virtual/range {v30 .. v31}, Landroid/view/View;->setIsRootNamespace(Z)V
    ...
    invoke-virtual/range {v30 .. v31}, Landroid/view/View;->postOnAnimation(Ljava/lang/Runnable;)V
    ...
    .line 3401
    .local v18, "multiStyle":Lcom/samsung/android/multiwindow/MultiWindowStyle;
    ...
    invoke-virtual/range {v30 .. v30}, Landroid/view/ViewGroup;->makeOptionalFitsSystemWindows()V
    ...
    invoke-virtual/range {v30 .. v31}, Landroid/view/View;->setLayoutDirection(I)V
    ...
    invoke-virtual/range {v30 .. v31}, Landroid/widget/FrameLayout;->setForeground(Landroid/graphics/drawable/Drawable;)V
    ...
    const-string v31, "com.sec.android.sdk.cover.MODE"

    const/16 v32, 0x0

    invoke-virtual/range {v30 .. v32}, Landroid/os/Bundle;->getInt(Ljava/lang/String;I)I
    :try_end_0
    ...
    invoke-virtual/range {v30 .. v32}, Landroid/content/pm/PackageManager;->getActivityInfo(Landroid/content/ComponentName;I)Landroid/content/pm/ActivityInfo;
    ...
    .end local v15    # "lp":Landroid/view/WindowManager$LayoutParams;
    .end local v18    # "multiStyle":Lcom/samsung/android/multiwindow/MultiWindowStyle;
    :cond_7
    return-void

    .line 3417
    .restart local v18    # "multiStyle":Lcom/samsung/android/multiwindow/MultiWindowStyle;
    ...
    check-cast v30, Lcom/android/internal/widget/ActionBarView;
    ...
    invoke-virtual/range {v30 .. v31}, Lcom/android/internal/widget/ActionBarView;->setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-virtual/range {v30 .. v30}, Lcom/android/internal/widget/ActionBarView;->getTitle()Ljava/lang/CharSequence;
    ...
    invoke-virtual/range {v30 .. v31}, Lcom/android/internal/widget/ActionBarView;->setWindowTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual/range {v30 .. v30}, Lcom/android/internal/widget/ActionBarView;->initProgress()V

    .line 3440
    :cond_c
    and-int/lit8 v30, v14, 0x20
    ...
    invoke-virtual/range {v30 .. v30}, Lcom/android/internal/widget/ActionBarView;->initIndeterminateProgress()V
    ...
    .line 3469
    .local v29, "windowPadding":Landroid/graphics/Rect;
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v30 .. v30}, Landroid/view/View;->getSystemUiVisibility()I
    ...
    invoke-virtual/range {v30 .. v31}, Landroid/view/View;->setSystemUiVisibility(I)V
    ...
    .end local v29    # "windowPadding":Landroid/graphics/Rect;
    :cond_11
    :goto_6
    const/16 v24, 0x0

    .line 3492
    .local v24, "splitActionBar":Z
    move-object/from16 v0, p0
    ...
    .line 3498
    .local v23, "smallestScreenWidthDp":I
    if-eqz v17, :cond_1a
    ...
    .line 3509
    .end local v23    # "smallestScreenWidthDp":I
    :goto_8
    const v30, 0x10203d6
    ...
    check-cast v25, Lcom/android/internal/widget/ActionBarContainer;

    .line 3511
    .local v25, "splitView":Lcom/android/internal/widget/ActionBarContainer;
    if-eqz v25, :cond_1c
    ...
    invoke-virtual/range {v30 .. v30}, Lcom/android/internal/widget/ActionBarView;->hasIcon()Z
    ...
    invoke-virtual/range {v30 .. v31}, Lcom/android/internal/widget/ActionBarView;->setIcon(I)V
    ...
    invoke-virtual/range {v30 .. v30}, Lcom/android/internal/widget/ActionBarView;->hasLogo()Z
    ...
    invoke-virtual/range {v30 .. v31}, Lcom/android/internal/widget/ActionBarView;->setLogo(I)V
    ...
    new-instance v31, Lcom/android/internal/policy/impl/PhoneWindow$2;
    ...
    invoke-virtual/range {v30 .. v31}, Landroid/view/View;->post(Ljava/lang/Runnable;)Z
    ...
    .end local v24    # "splitActionBar":Z
    .end local v25    # "splitView":Lcom/android/internal/widget/ActionBarContainer;
    .end local v26    # "splitWhenNarrow":Z
    :cond_17
    const/16 v30, 0x0
    ...
    .restart local v29    # "windowPadding":Landroid/graphics/Rect;
    :cond_18
    if-eqz v18, :cond_11
    ...
    .end local v22    # "s":Landroid/app/StatusBarManager;
    .end local v29    # "windowPadding":Landroid/graphics/Rect;
    .restart local v24    # "splitActionBar":Z
    :cond_19
    const/16 v26, 0x0
    ...
    .line 3502
    .restart local v23    # "smallestScreenWidthDp":I
    .restart local v26    # "splitWhenNarrow":Z
    :cond_1a
    invoke-virtual/range {p0 .. p0}, Landroid/view/Window;->getContext()Landroid/content/Context;
    ...
    invoke-virtual/range {v30 .. v32}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z
    ...
    .line 3521
    .restart local v25    # "splitView":Lcom/android/internal/widget/ActionBarContainer;
    :cond_1c
    if-eqz v24, :cond_12

    .line 3522
    const-string v30, "PhoneWindow"

    const-string v31, "Requested split action bar with incompatible window decor! Ignoring request."
    ...
    invoke-virtual/range {v31 .. v31}, Landroid/content/pm/PackageManager;->getDefaultActivityIcon()Landroid/graphics/drawable/Drawable;

    move-result-object v31

    invoke-virtual/range {v30 .. v31}, Lcom/android/internal/widget/ActionBarView;->setIcon(Landroid/graphics/drawable/Drawable;)V
...
.method private openPanel(Lcom/android/internal/policy/impl/PhoneWindow$PanelFeatureState;Landroid/view/KeyEvent;)V
    ...
    .line 638
    .local v15, "hasNaviBar":Z
    :try_start_0
    sget-object v4, Lcom/android/internal/policy/impl/PhoneWindow$WindowManagerHolder;->sWindowManager:Landroid/view/IWindowManager;
    ...
    .line 639
    .restart local v15    # "hasNaviBar":Z
    .restart local v16    # "isHoneycombApp":Z
    :catch_0
    move-exception v14
    ...
    .line 701
    .local v18, "shownPanelParent":Landroid/view/ViewParent;
    if-eqz v18, :cond_9
    ...
    .end local v18    # "shownPanelParent":Landroid/view/ViewParent;
    move-object/from16 v0, p1
