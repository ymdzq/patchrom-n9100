...
.method public constructor <init>()V
    ...
    .line 736
    iput-object v2, p0, Landroid/app/Activity;->mSubDecor:Landroid/view/View;
...
.method final attach(Landroid/content/Context;Landroid/app/ActivityThread;Landroid/app/Instrumentation;Landroid/os/IBinder;ILandroid/app/Application;Landroid/content/Intent;Landroid/content/pm/ActivityInfo;Ljava/lang/CharSequence;Landroid/app/Activity;Ljava/lang/String;Landroid/app/Activity$NonConfigurationInstances;Landroid/content/res/Configuration;)V
    ...
    iget-object v4, p0, Landroid/app/Activity;->mContainer:Landroid/app/FragmentContainer;

    const/4 v5, 0x0

    invoke-virtual {v3, p0, v4, v5}, Landroid/app/FragmentManagerImpl;->attachActivity(Landroid/app/Activity;Landroid/app/FragmentContainer;Landroid/app/Fragment;)V
    ...
    invoke-virtual {v2, v0}, Lcom/samsung/android/multiwindow/MultiWindowStyle;->isMultiPhoneWindowNeeded(Landroid/content/pm/ActivityInfo;)Z
    ...
    invoke-static {p0, v3}, Lcom/android/internal/policy/PolicyManager;->makeNewWindow(Landroid/content/Context;Z)Landroid/view/Window;

    move-result-object v3

    iput-object v3, p0, Landroid/app/Activity;->mWindow:Landroid/view/Window;
    ...
    :try_start_0
    invoke-interface {v1}, Landroid/view/IWindowManager;->hasCocktailBar()Z
    ...
    iput-object v3, p0, Landroid/app/Activity;->mSubWindow:Landroid/view/Window;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v3}, Landroid/view/Window;->getLayoutInflater()Landroid/view/LayoutInflater;

    move-result-object v3

    invoke-virtual {v3, p0}, Landroid/view/LayoutInflater;->setPrivateFactory(Landroid/view/LayoutInflater$Factory2;)V

    .line 5560
    move-object/from16 v0, p8

    iget v3, v0, Landroid/content/pm/ActivityInfo;->softInputMode:I
    ...
    iget v4, v0, Landroid/content/pm/ActivityInfo;->softInputMode:I
    ...
    iget v3, v0, Landroid/content/pm/ActivityInfo;->uiOptions:I
    ...
    iget v4, v0, Landroid/content/pm/ActivityInfo;->uiOptions:I

    invoke-virtual {v3, v4}, Landroid/view/Window;->setUiOptions(I)V
    ...
    iput-object v3, p0, Landroid/app/Activity;->mUiThread:Ljava/lang/Thread;
    ...
    iput-object v3, p0, Landroid/app/Activity;->mComponent:Landroid/content/ComponentName;
    ...
    :goto_2
    invoke-virtual {v5, v3, v6, v7, v4}, Landroid/view/Window;->setWindowManager(Landroid/view/WindowManager;Landroid/os/IBinder;Ljava/lang/String;Z)V
    ...
    iput-object v3, p0, Landroid/app/Activity;->mWindowManager:Landroid/view/WindowManager;
    ...
    .line 5544
    .end local v1    # "iwm":Landroid/view/IWindowManager;
    :cond_4
    ...
    .line 5583
    .restart local v1    # "iwm":Landroid/view/IWindowManager;
    :cond_5
    const/4 v4, 0x0
...
.method public convertToTranslucent()V
    ...
    invoke-virtual {p0, v0}, Landroid/app/Activity;->convertToTranslucent(Landroid/app/Activity$TranslucentConversionListener;)V
...
.method public keepScreenForAppStartingWindow()V
    ...
    invoke-interface {v0, v1}, Landroid/app/IActivityManager;->keepScreenForAppStartingWindow(Landroid/os/IBinder;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected onResume()V
    ...
    instance-of v7, v7, Landroid/app/TabActivity;
    ...
    const-string v8, "#0 Is Incall UI FullScreen"
    ...
    const-string v8, "#4 setTransGradationMode to false:"

    invoke-static {v7, v8}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1199
    invoke-virtual {v5, v9}, Landroid/app/StatusBarManager;->setTransGradationMode(Z)V
    ...
    const-string v8, "#1 setTransGradationModeColor false"
    ...
    const-string v8, "#2 setTransGradationModeColor to true"
    ...
    const-string v8, "#3 setTransGradationModeColor to false"
