...
.method public addSecretPackage(Ljava/lang/String;I)Z
    ...
    invoke-interface {v1, p1, p2}, Landroid/content/pm/IPackageManager;->addSecretPackage(Ljava/lang/String;I)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public clearSecretPackageList(I)V
    ...
    invoke-interface {v1, p1}, Landroid/content/pm/IPackageManager;->clearSecretPackageList(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getCSCPackageItemIcon(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v8}, Landroid/telephony/MultiSimTelephonyManager;->getSimOperator()Ljava/lang/String;
    ...
    invoke-virtual {v8}, Landroid/app/ActivityThread;->getCSCAppIconMap()Landroid/util/ArrayMap;
    ...
    const-string v11, "getCSCPackageItemIcon IconFailure retrieving icon 0x"
...
.method public getCSCPackageItemText(Ljava/lang/String;)Ljava/lang/CharSequence;
    ...
    const-string v12, "com.android.stk.StkLauncherActivity"
    ...
    const-string v12, "com.android.stk.StkLauncherActivity1"
    ...
    const-string v12, "com.sec.android.app.latin.launcher.stk"
    ...
    const-string v12, "com.sec.android.app.latin.launcher.stk.StkShortcutWidget"
    ...
    .line 809
    .local v6, "mSplitStkTitle":[Ljava/lang/String;
    const/4 v12, 0x0
    ...
    .end local v6    # "mSplitStkTitle":[Ljava/lang/String;
    :cond_2
    :goto_0
    return-object v11
    ...
    .line 813
    .local v5, "mSplitNoSIM":[Ljava/lang/String;
    const/4 v12, 0x1
    ...
    .line 814
    .restart local v6    # "mSplitStkTitle":[Ljava/lang/String;
    const/4 v12, 0x0
    ...
    .line 820
    .end local v3    # "fixedStkTitle":Ljava/lang/String;
    .end local v5    # "mSplitNoSIM":[Ljava/lang/String;
    .end local v6    # "mSplitStkTitle":[Ljava/lang/String;
    :cond_5
    const-string v12, "gsm.STK_SETUP_MENU"
    ...
    const-string v12, "com.android.stk2.StkLauncherActivity2"
    ...
    const-string v12, "com.android.stk2.StkLauncherActivity"
    ...
    .end local v6    # "mSplitStkTitle":[Ljava/lang/String;
    :cond_9
    const-string v12, "gsm.STK_SETUP_MENU2"
    ...
    iget-object v12, v12, Landroid/app/ContextImpl;->mMainThread:Landroid/app/ActivityThread;

    invoke-virtual {v12}, Landroid/app/ActivityThread;->getCSCAppStringMap()Landroid/util/ArrayMap;

    move-result-object v1

    .line 875
    .local v1, "cscStringMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/lang/Integer;>;"
    ...
    invoke-direct {v7, v0, v9}, Landroid/app/ApplicationPackageManager$ResourceName;-><init>(Ljava/lang/String;I)V

    .line 879
    .local v7, "name":Landroid/app/ApplicationPackageManager$ResourceName;
    move-object/from16 v0, p0

    invoke-direct {v0, v7}, Landroid/app/ApplicationPackageManager;->getCachedString(Landroid/app/ApplicationPackageManager$ResourceName;)Ljava/lang/CharSequence;
    ...
    const-string v13, "/system/csc/appresource/CSCAppResource.apk"
    ...
    invoke-virtual/range {v12 .. v16}, Landroid/app/ActivityThread;->getTopLevelResources(Ljava/lang/String;ILandroid/content/res/Configuration;Landroid/app/LoadedApk;)Landroid/content/res/Resources;
    ...
    invoke-direct {v0, v7, v11}, Landroid/app/ApplicationPackageManager;->putCachedString(Landroid/app/ApplicationPackageManager$ResourceName;Ljava/lang/CharSequence;)V
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v14, "getCSCPackageItemText Failure retrieving text 0x"
    ...
    .line 904
    .end local v2    # "e":Ljava/lang/RuntimeException;
    .end local v7    # "name":Landroid/app/ApplicationPackageManager$ResourceName;
...
.method public getSecretPackageList(I)Ljava/util/List;
    ...
    invoke-interface {v1, p1}, Landroid/content/pm/IPackageManager;->getSecretPackageList(I)Ljava/util/List;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public removeSecretPackage(Ljava/lang/String;I)Z
    ...
    invoke-interface {v1, p1, p2}, Landroid/content/pm/IPackageManager;->removeSecretPackage(Ljava/lang/String;I)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setSecretPackageList(Ljava/util/List;I)V
    ...
    invoke-interface {v1, p1, p2}, Landroid/content/pm/IPackageManager;->setSecretPackageList(Ljava/util/List;I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
