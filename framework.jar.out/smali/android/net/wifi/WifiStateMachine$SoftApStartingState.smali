...
.method public enter()V
    ...
    invoke-static {v2}, Landroid/net/wifi/WifiStateMachine;->access$40600(Landroid/net/wifi/WifiStateMachine;)Landroid/os/Message;
    ...
    invoke-static {v2}, Landroid/net/wifi/WifiStateMachine;->access$9900(Landroid/net/wifi/WifiStateMachine;)Lcom/android/internal/util/AsyncChannel;
    ...
    invoke-static {v2}, Landroid/net/wifi/WifiStateMachine;->access$40700(Landroid/net/wifi/WifiStateMachine;)I
    ...
    invoke-static {v2, v0}, Landroid/net/wifi/WifiStateMachine;->access$40900(Landroid/net/wifi/WifiStateMachine;Landroid/net/wifi/WifiConfiguration;)V
    ...
    invoke-static {v2, v3}, Landroid/net/wifi/WifiStateMachine;->access$40800(Landroid/net/wifi/WifiStateMachine;Ljava/lang/String;)V
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v2, v3}, Landroid/net/wifi/WifiStateMachine;->access$41100(Landroid/net/wifi/WifiStateMachine;Ljava/lang/String;)V
    ...
    invoke-static {v2}, Landroid/net/wifi/WifiStateMachine;->access$13100(Landroid/net/wifi/WifiStateMachine;)I
    ...
    invoke-static {v3}, Landroid/net/wifi/WifiStateMachine;->access$41200(Landroid/net/wifi/WifiStateMachine;)Lcom/android/internal/util/State;

    move-result-object v3

    # invokes: Landroid/net/wifi/WifiStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v2, v3}, Landroid/net/wifi/WifiStateMachine;->access$41300(Landroid/net/wifi/WifiStateMachine;Lcom/android/internal/util/IState;)V
    ...
    invoke-static {v2, v3}, Landroid/net/wifi/WifiStateMachine;->access$7402(Landroid/net/wifi/WifiStateMachine;I)I
    ...
    # invokes: Landroid/net/wifi/WifiStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v2, v3}, Landroid/net/wifi/WifiStateMachine;->access$41400(Landroid/net/wifi/WifiStateMachine;Lcom/android/internal/util/IState;)V
