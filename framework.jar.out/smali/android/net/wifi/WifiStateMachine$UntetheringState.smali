...
.method public enter()V
    ...
    invoke-static {v0, v1}, Landroid/net/wifi/WifiStateMachine;->access$43600(Landroid/net/wifi/WifiStateMachine;Ljava/lang/String;)V
    ...
    # invokes: Landroid/net/wifi/WifiStateMachine;->log(Ljava/lang/String;)V
    invoke-static {v0, v1}, Landroid/net/wifi/WifiStateMachine;->access$43700(Landroid/net/wifi/WifiStateMachine;Ljava/lang/String;)V
    ...
    invoke-static {v0, v4}, Landroid/net/wifi/WifiStateMachine;->access$40702(Landroid/net/wifi/WifiStateMachine;I)I

    .line 9644
    iget-object v0, p0, Landroid/net/wifi/WifiStateMachine$UntetheringState;->this$0:Landroid/net/wifi/WifiStateMachine;

    # getter for: Landroid/net/wifi/WifiStateMachine;->mPreviousTetherData:I
    invoke-static {v0}, Landroid/net/wifi/WifiStateMachine;->access$43800(Landroid/net/wifi/WifiStateMachine;)I
    ...
    invoke-static {v0, v4}, Landroid/net/wifi/WifiStateMachine;->access$43802(Landroid/net/wifi/WifiStateMachine;I)I
    ...
    # invokes: Landroid/net/wifi/WifiStateMachine;->log(Ljava/lang/String;)V
    invoke-static {v0, v1}, Landroid/net/wifi/WifiStateMachine;->access$43900(Landroid/net/wifi/WifiStateMachine;Ljava/lang/String;)V
    ...
    invoke-static {v3}, Landroid/net/wifi/WifiStateMachine;->access$42204(Landroid/net/wifi/WifiStateMachine;)I
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v1, v2}, Landroid/net/wifi/WifiStateMachine;->access$42300(Landroid/net/wifi/WifiStateMachine;Ljava/util/ArrayList;)Z
    ...
    invoke-static {v2}, Landroid/net/wifi/WifiStateMachine;->access$41200(Landroid/net/wifi/WifiStateMachine;)Lcom/android/internal/util/State;

    move-result-object v2

    # invokes: Landroid/net/wifi/WifiStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v1, v2}, Landroid/net/wifi/WifiStateMachine;->access$44000(Landroid/net/wifi/WifiStateMachine;Lcom/android/internal/util/IState;)V
    ...
    invoke-static {v2}, Landroid/net/wifi/WifiStateMachine;->access$42200(Landroid/net/wifi/WifiStateMachine;)I
    ...
    invoke-static {v1, v2}, Landroid/net/wifi/WifiStateMachine;->access$44100(Landroid/net/wifi/WifiStateMachine;Ljava/lang/String;)V
    ...
    # invokes: Landroid/net/wifi/WifiStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v1, v2}, Landroid/net/wifi/WifiStateMachine;->access$44200(Landroid/net/wifi/WifiStateMachine;Lcom/android/internal/util/IState;)V
    ...
    invoke-static {v1, p1}, Landroid/net/wifi/WifiStateMachine;->access$44300(Landroid/net/wifi/WifiStateMachine;Landroid/os/Message;)V
