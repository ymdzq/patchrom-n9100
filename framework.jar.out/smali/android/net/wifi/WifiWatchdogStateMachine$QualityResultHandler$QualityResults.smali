...
.method private displayNotification()V
    ...
    invoke-static {v2}, Landroid/net/wifi/WifiWatchdogStateMachine$QualityResultHandler;->access$14500(Landroid/net/wifi/WifiWatchdogStateMachine$QualityResultHandler;)Ljava/lang/String;
    ...
    invoke-static {v2}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$14700(Landroid/net/wifi/WifiWatchdogStateMachine;)Landroid/app/NotificationManager;
    ...
    invoke-static {v3, v2}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$14702(Landroid/net/wifi/WifiWatchdogStateMachine;Landroid/app/NotificationManager;)Landroid/app/NotificationManager;
...
.method public writeResults()V
    ...
    # getter for: Landroid/net/wifi/WifiWatchdogStateMachine$QualityResultHandler;->TAG:Ljava/lang/String;
    invoke-static {v6}, Landroid/net/wifi/WifiWatchdogStateMachine$QualityResultHandler;->access$14500(Landroid/net/wifi/WifiWatchdogStateMachine$QualityResultHandler;)Ljava/lang/String;
    ...
    invoke-static {v7}, Landroid/net/wifi/WifiWatchdogStateMachine$QualityResultHandler;->access$14600(Landroid/net/wifi/WifiWatchdogStateMachine$QualityResultHandler;)Ljava/text/SimpleDateFormat;
    ...
    # getter for: Landroid/net/wifi/WifiWatchdogStateMachine$QualityResultHandler;->TAG:Ljava/lang/String;
    invoke-static {v7}, Landroid/net/wifi/WifiWatchdogStateMachine$QualityResultHandler;->access$14500(Landroid/net/wifi/WifiWatchdogStateMachine$QualityResultHandler;)Ljava/lang/String;
