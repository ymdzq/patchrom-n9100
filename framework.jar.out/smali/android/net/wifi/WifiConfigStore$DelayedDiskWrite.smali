...
.method private static onWriteCalled(Ljava/util/List;)V
    ...
    .line 1424
    invoke-virtual {v13}, Landroid/net/ProxyProperties;->getUsername()Ljava/lang/String;

    move-result-object v16

    if-eqz v16, :cond_a

    invoke-virtual {v13}, Landroid/net/ProxyProperties;->getPassword()Ljava/lang/String;
    ...
    .line 1425
    const-string v16, "proxyUsername"
    ...
    .line 1427
    const-string v16, "proxyPassword"
