...
.method public constructor <init>(Landroid/widget/AbsHorizontalListView;)V
    ...
    invoke-virtual {v11, v5}, Landroid/view/View;->setMinimumWidth(I)V
    ...
    invoke-virtual {v15, v6}, Landroid/view/View;->setMinimumHeight(I)V
    ...
    invoke-virtual {v15, v9}, Landroid/view/View;->setMinimumHeight(I)V
    ...
    invoke-virtual {v15}, Landroid/view/View;->getVerticalScrollbarPosition()I
...
.method private transitionPreviewLayout(I)Z
    ...
    iget-object v11, v0, Landroid/widget/HorizontalFastScroller;->mSections:[Ljava/lang/Object;
    ...
    iget-object v2, v0, Landroid/widget/HorizontalFastScroller;->mTempBounds:Landroid/graphics/Rect;

    .line 1034
    .local v2, "bounds":Landroid/graphics/Rect;
    move-object/from16 v0, p0

    iget-object v5, v0, Landroid/widget/HorizontalFastScroller;->mPreviewImage:Landroid/widget/ImageView;
    ...
    iget-object v13, v0, Landroid/widget/HorizontalFastScroller;->mPrimaryText:Landroid/widget/TextView;
    ...
    invoke-direct {v0, v15, v2}, Landroid/widget/HorizontalFastScroller;->measurePreview(Landroid/view/View;Landroid/graphics/Rect;)V

    .line 1048
    move-object/from16 v0, p0

    invoke-direct {v0, v15, v2}, Landroid/widget/HorizontalFastScroller;->applyLayout(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-static {v13, v0}, Landroid/widget/HorizontalFastScroller;->animateAlpha(Landroid/view/View;F)Landroid/animation/Animator;
    ...
    .line 1064
    invoke-static {v5, v2}, Landroid/widget/HorizontalFastScroller;->animateBounds(Landroid/view/View;Landroid/graphics/Rect;)Landroid/animation/Animator;
    ...
    invoke-static {v15, v0}, Landroid/widget/HorizontalFastScroller;->animateScaleX(Landroid/view/View;F)Landroid/animation/Animator;
    ...
    .line 1091
    .local v8, "scale":F
    invoke-static {v13, v8}, Landroid/widget/HorizontalFastScroller;->animateScaleX(Landroid/view/View;F)Landroid/animation/Animator;
    ...
    iget-object v13, v0, Landroid/widget/HorizontalFastScroller;->mSecondaryText:Landroid/widget/TextView;
